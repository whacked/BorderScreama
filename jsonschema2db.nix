...
let
  change_case = python38.pkgs.buildPythonPackage rec {
    pname = "change_case";
    version = "0.5.2";
  ...
  jsonschema2db = python38.pkgs.buildPythonPackage rec {
    pname = "JSONSchema2DB";
    version = "1.0.1";
...
in
  python38.withPackages (ps: [jsonschema2db])
